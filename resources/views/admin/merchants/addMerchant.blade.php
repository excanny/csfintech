...
@section('page-title') Add Merchant @stop

@section('breadcrumb1') <li class="breadcrumb-item">Merchants</li> @stop

@section('breadcrumb2')<li class="breadcrumb-item">Add Merchants</li>@stop
            ...
            <div class="col-md-6 col-sm-6 grid-margin stretch-card" style="margin: auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{route('merchants.add')}}">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label for="business_name" class="important">Name of Business</label>
                                <input type="text"
                                       class="form-control"
                                       required
                                       id="business_name"
